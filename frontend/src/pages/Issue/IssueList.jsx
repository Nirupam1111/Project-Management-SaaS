      ...
      <Dialog>
        <Card className="w-full md:w-[300px] lg:w-[310px] ">
          <CardHeader className="">
            <CardTitle><span className="font-sans">{title}</span></CardTitle>
          </CardHeader>
          ...
          <CardFooter className="px-2">
            <DialogTrigger>
              <Button
                ...
                variant="outline"
              >
                <PlusIcon /> <span className="font-sans">Create Issue</span>
              </Button>
            </DialogTrigger>
          </CardFooter>
        </Card>
        <DialogContent className="border-none w-[300px]">
          <DialogHeader>
            <DialogTitle><span className="font-sans">Create New Issue</span></DialogTitle>
          </DialogHeader>
